...
def plot_results_with_emergence(
    ...
    axes[2,0].imshow(real.T, cmap='gray', alpha=0.5, aspect='auto')
    axes[2,0].imshow(predicted.T, cmap='gray', alpha=0.5, aspect='auto')
    ...
    axes[2,1].imshow(emergent_real.T, cmap='gray', alpha=0.5, aspect='auto')
    axes[2,1].imshow(emergent_predicted.T, cmap='gray', alpha=0.5, aspect='auto')
